...
SECRET_KEY = 'django-insecure-a)$7f(73#tsv*g8!wffy_gs@c)att1c5h6oyjt4cn8z4jy#0i3'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'OddamApp' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'charity-donation',  # Nazwa bazy danych
